...
const Step = ({ data, changeData }) => {
    ...
    return <>
        <div className='etapas'>
            ...
            <span className={infoId === (stepsNumber - 1) || Number(sessionStorage.getItem(`${vistoria.id}_stp`)) <= infoId ? 'disable' : ''} onClick={infoId !== (stepsNumber - 1) ? () => changeData(prev => ({...prev, currentStep: prev.currentStep + 1})) : null}>&gt;</span>
