...
const Step = ({ data, changeData }) => {
    ...
    return <>
        <div className='etapas'>
            ...
            <span className={infoId === (stepsNumber - 1) || Number(sessionStorage.getItem(`${vistoria.id}_stp`)) <= infoId ? 'disable' : ''} onClick={() => changeData(prev => ({...prev, currentStep: prev.currentStep + 1}))}>&gt;</span>
